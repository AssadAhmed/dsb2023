...
-  Will the model have a coefficient for `rated` NC-17? - no coefficient as there will be no data to suppourt any degree of dependency on the rating
...
-   What, if anything, gave you the most trouble: Initially tried running hte model with 10 folds which didn't end well...
